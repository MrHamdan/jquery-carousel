(function (root, factory) {
    ...
    let hamdan = function (slider, options) {
        ...
        if (options.showControls && orgNumSlides > 1) {
            slider.prepend(
                '<a href="#" class="as-prev-arrow" title="LABEL"><i class="far fa-arrow-alt-circle-left"></i></a>'.replace(
                    /LABEL/g,
                    options.prevLabel
                )
            );
            slider.append(
                '<a href="#" class="as-next-arrow" title="LABEL"><i class="far fa-arrow-alt-circle-right"></i></a>'.replace(
                    /LABEL/g,
                    options.nextLabel
                )
            );

            slider.on("click", ".as-prev-arrow, .as-next-arrow", function (e) {
                e.preventDefault();
    ...
    $.fn.hamdan = function (options) {
        return this.each(function () {
            let slider = $(this),
                nothing = new hamdan(slider, options);
        });
    };
}); 